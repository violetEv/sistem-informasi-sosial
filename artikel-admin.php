  ...
  <body>
    <div class="artikel">
        ...
        <div class="paragraph-container">
          ...
          <div class="frame-3">
            ...
            <div class="div-2">
              ...
              <div class="frame-7">
                <button type="submit" class="button" onclick="return validateForm()"><div class="text-3">Tambahkan</div></button>
      ...
      <div class="frame-8"  id="lihat-artikel">
        ...
        <div class="category">
          <button type="button" data-category="bansos" onclick="changeCategory('bansos')" class="button-no"><div class="text-5">Bantuan Sosial</div></button>
